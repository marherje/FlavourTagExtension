...
path="/lhome/ific/m/marherje/FlavourTagExtension/ReTraining250_G05"
source ${path}/init_ilcsoft_patch.sh
cp -r ${path}/lib $PWD/.
cp -r ${path}/data $PWD/.
cp -r ${path}/lcfiweights $PWD/.
#cp ${path}/GearOutput.xml $PWD/.
cp ${path}/test_xPROD_xNAMEAUX_xFLAVOUR_xNAMEfile_Kisr_xISRCUT.xml .
...
echo $PWD
Marlin ${PWD}/test_xPROD_xNAMEAUX_xFLAVOUR_xNAMEfile_Kisr_xISRCUT.xml
