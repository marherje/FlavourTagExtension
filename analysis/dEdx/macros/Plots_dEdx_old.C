...
void Labels(TString pol, TString tracks, TString ignoreoverlay, TString cut, TString quark){
  ...
  if(tracks=="secondary")track_string="Secondary";
  else track_string="All";

  TString quark_string;
  if(quark=="light")quark_string="uds-jets";
  else if(quark=="c")quark_string="c-jets";
  else if(quark=="b")quark_string="b-jets";
  
  TString mom_string;
  if(cut=="0")mom_string="";
  else mom_string=", p_{track} > "+cut+" GeV";

  QQBARLabel2(0.6,0.82, track_string+" tracks in "+quark_string,kGray+4);
  QQBARLabel2(0.5,0.965, "Work in progress",kRed+2);
  QQBARLabel2(0.05,0.05, "K_{#gamma} < 50 GeV"+mom_string,kGray+2);
}


void EffPurity_default(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  Labels("eL",secondary,ignoreoverlay,cut,quark);
  ...
  TCanvas* c_def2 = new TCanvas("c_def2","c_def2",800,800);
  c_def2->cd(1);
  c_def2->SetGrid();
  ...
  Labels("eR",secondary,ignoreoverlay,cut,quark);
...
void EffPurity_dedxdist(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  TCanvas* c_dist = new TCanvas("c_dist","c_dist",800,800);
  c_dist->cd(1);
  c_dist->SetGrid();
  ...
  Labels("",secondary,ignoreoverlay,cut,quark);
  ...
  TCanvas* c_dist2 = new TCanvas("c_dist2","c_dist2",800,800);
  c_dist2->cd(1);
  c_dist2->SetGrid();
  efficiency_purity->GetXaxis()->SetTitle("Efficiency [%]");
  efficiency_purity->GetYaxis()->SetTitle("Purity [%]");
...
void EffPurity_dedxdist3(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  TCanvas* c_dist3 = new TCanvas("c_dist3","c_dist3",800,800);
  c_dist3->cd(1);
  c_dist3->SetGrid();
 ...
 TCanvas* c_dist32 = new TCanvas("c_dist32","c_dist32",800,800);
  c_dist32->cd(1);
  c_dist32->SetGrid();
...
void EffPurity_dedxdist4(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  TCanvas* c_dist4 = new TCanvas("c_dist4","c_dist4",800,800);
  c_dist4->cd(1);
  c_dist4->SetGrid();
 ...
 TCanvas* c_dist42 = new TCanvas("c_dist42","c_dist42",800,800);
  c_dist42->cd(1);
  c_dist42->SetGrid();
...
void EffPurity_dedxdist5(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  TCanvas* c_dist5 = new TCanvas("c_dist5","c_dist5",800,800);
  c_dist5->cd(1);
  c_dist5->SetGrid();
 ...
 TCanvas* c_dist52 = new TCanvas("c_dist52","c_dist52",800,800);
  c_dist52->cd(1);
  c_dist52->SetGrid();
...
void EffPurity_dedxdist2(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  TCanvas* c_dist22 = new TCanvas("c_dist22","c_dist22",800,800);
  c_dist22->cd(1);
  c_dist22->SetGrid();
  efficiency_purity->GetXaxis()->SetTitle("Efficiency [%]");
  efficiency_purity->GetYaxis()->SetTitle("Purity [%]");
...
void Mom(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
...
void dEdxdist(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
  ...
  TCanvas* c_dist1 = new TCanvas("c_dist1","c_dist1",800,800);
  c_dist1->cd(1);
  c_dist1->SetGrid();
  kdEdx_dist_pion->GetXaxis()->SetTitle("signed (dEdx-dEdx_{exp-kaon})/#Delta_{dEdx}");
  ...
  */
  ...
  TCanvas* c_dist12 = new TCanvas("c_dist12","c_dist12",800,800);
  c_dist12->cd(1);
  c_dist12->SetGrid();

  kdEdx_dist_pion2->GetXaxis()->SetTitle("signed (dEdx-dEdx_{exp-kaon})/#Delta_{dEdx}");
...
void dEdx_p_cos(TString filename, TString filename2, TString secondary, TString ignoreoverlay, TString cut, TString quark){
...
void Plots_dEdx(TString tracks, TString ignoreoverlay, TString cut, TString quark) {
  TString filename ="../output/output_500_"+tracks+"_tracks_500GeV_eL_pR_cut_"+cut+"_"+quark+"quark"+".root";
  TString filename2 ="../output/output_500_"+tracks+"_tracks_500GeV_eR_pL_cut_"+cut+"_"+quark+"quark"+".root";
  
  Mom(filename,filename2,tracks,ignoreoverlay,cut,quark);
  EffPurity_default(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //EffPurity_dedxdist(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //EffPurity_dedxdist2(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //EffPurity_dedxdist3(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //EffPurity_dedxdist4(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //EffPurity_dedxdist5(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //dEdxdist(filename,filename2,tracks,ignoreoverlay,cut,quark);
  //dEdx_p_cos(filename,filename2,tracks,ignoreoverlay,cut,quark);
}
